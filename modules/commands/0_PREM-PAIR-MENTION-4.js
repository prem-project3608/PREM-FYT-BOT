...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.postimg.cc/4yHpkp6L/In-Shot-20230913-160544880.jpg", path); 
}
...
async function makeImage({ one, two }) {
    ...
    batgiam_img.composite(circleOne.resize(380,380), 146, 178).composite(circleTwo.resize(380, 380), 740, 178);
